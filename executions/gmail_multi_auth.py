...
Each account gets its own token file (config/token_<account_name>.json).

Usage:
    python3 execution/gmail_multi_auth.py --account leftclick
    python3 execution/gmail_multi_auth.py --account nicksaraev
...
CREDENTIALS_MAP = {
    "leftclick": "config/credentials_leftclick.json",
    "nicksaraev": "config/credentials.json",
}
DEFAULT_CREDENTIALS = "config/credentials.json"
...
def get_token_file(account_name: str) -> str:
    ...
    return f"config/token_{account_name}.json"
...
Examples:
  Authorize an account:
    python3 execution/gmail_multi_auth.py --account leftclick
    python3 execution/gmail_multi_auth.py --account nicksaraev --email nick@nicksaraev.com
