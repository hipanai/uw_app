---
name: google-serp-leads
description: Scrape Google search results for local businesses and extract contacts. Use for SERP-based lead generation.
scripts:
  - execution/extract_website_contacts.py
---
