...
description: Auto-generate intelligent replies to Instantly campaign emails using knowledge bases. Use for automated email responses.
scripts:
  - execution/instantly_autoreply.py
---
