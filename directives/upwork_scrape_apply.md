---
name: upwork-apply
description: Scrape Upwork jobs and generate personalized proposals. Use when applying to freelance gigs.
scripts:
  - execution/upwork_apify_scraper.py
  - execution/upwork_proposal_generator.py
---
