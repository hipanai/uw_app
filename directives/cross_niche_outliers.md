...
description: Find high-performing videos from adjacent niches to extract content patterns. Use for content ideation from non-competing channels.
scripts:
  - execution/scrape_cross_niche_outliers.py
---
